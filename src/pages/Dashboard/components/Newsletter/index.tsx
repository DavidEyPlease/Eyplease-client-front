...
const Newsletter = () => {
    ...
    return (
        <div className="overflow-hidden rounded-3xl border bg-card shadow-card">
            <div className="relative border-b bg-hero-glow p-5">
            ...
            {initialLoading ? (
                ...
                <div className="grid lg:grid-cols-[1fr_328px]">
                    <div className="flex flex-col border-b p-5 lg:border-b-0 lg:border-r">
                        <WizardStepper
                            steps={steps}
                        ...
                        {submitted ? (
                            <div className="mt-1.5 border-t py-4">
                            ...
                            <div className="mt-1.5 flex items-center gap-3 border-t py-4">
                                <button
                                    type="button"
