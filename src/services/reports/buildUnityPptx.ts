...
// datos y paginación; el front solo pinta el payload de layout zona por zona.
// Devuelve el .pptx como Blob para descarga diferida (no auto-descarga).
export const buildUnityPptx = async (
